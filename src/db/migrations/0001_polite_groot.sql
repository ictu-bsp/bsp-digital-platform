...
ALTER TABLE "activity_payments" ADD CONSTRAINT "activity_payments_registration_id_activity_registrations_id_fk" FOREIGN KEY ("registration_id") REFERENCES "public"."activity_registrations"("id") ON DELETE no action ON UPDATE no action;