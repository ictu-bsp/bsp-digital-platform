        ...
        <div className="flex-1 px-4 py-6">
          ...
          <div className="mt-5 rounded-2xl border border-red-200 bg-red-50 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-700">
              You will be removed from the participant list immediately. You may
              join again later provided registration is still open and the
              activity has not reached its maximum capacity.
            </p>
