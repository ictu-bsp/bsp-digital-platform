...
export default function SignUpPage() {
  ...
  // Safe From Harm Policy Modal state
  ...
  const submitRegistration = async () => {
    ...
    // Pass email and age to the verification route
    router.push(
  ...
  return (
    <>
      ...
      {/* Safe From Harm Policy & Privacy Terms Modal */}
      {showPolicyModal && (
          ...
          <div className="flex max-h-[90vh] w-full max-w-lg flex-col rounded-2xl bg-white p-6 shadow-xl">
            ...
            >
              ...
              <p>
                ...
                behavior that compromises physical, emotional, or digital safety.
                Any misconduct or suspected breach of safety guidelines will
                result in account review or immediate suspension.
              </p>
