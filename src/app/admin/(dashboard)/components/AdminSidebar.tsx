...
export default function AdminSidebar({ role }: { role: AdminRole }) {
  ...
  return <aside className="w-64 shrink-0 border-r border-zinc-200 bg-white px-3 py-6 sticky top-4 self-start max-h-[calc(100vh-2rem)] overflow-y-auto"><AdminSidebarClient menu={menu} /></aside>;
}