"use client";
// src/app/payments/components/CreditCard.tsx
...
export default function CreditCard({ amount, description }: CreditCardProps) {
    ...
    for (let i = 5; i > 0; i--) {
      ...
      if (i === 1) {
        ...
        if (paymentIntentData.attributes.last_payment_error) {
          ...
          localStorage.setItem("paymentMethodLabel", "Credit/Debit Card");
          router.push("/payments/success?status=failed");
