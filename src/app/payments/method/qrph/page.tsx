"use client";
// src/app/payments/method/qrph/page.tsx
// Reached after the user picks "QR Ph" on /payments/method.
// Reads the amount + description that register/page.tsx saved to
// localStorage, then hands them to the existing QRPay component.
